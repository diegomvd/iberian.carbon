...
from nan_robust_regression_metrics import NanRobustMeanAbsoluteError, NanRobustMeanAbsolutePercentageError, NanRobustMeanSquaredError, NanRobustThresholdedMeanAbsoluteError, NanRobustThresholdedMeanAbsolutePercentageError, NanRobustThresholdedMeanSquaredError
...
class NanRobustHeightThresholdPixelWiseRegressionTask(PixelwiseRegressionTask):
    ...
    def configure_metrics(self) -> None:
        ...
        * :class:`~torchmetrics.MeanAbsoluteError`: The average of the absolute
        ...
        metrics = MetricCollection(
            {
                'RMSE': NanRobustThresholdedMeanSquaredError(squared=False),
                'MSE': NanRobustThresholdedMeanSquaredError(squared=True),
                'MAE': NanRobustThresholdedMeanAbsoluteError(),
                'MAPE': NanRobustThresholdedMeanAbsolutePercentageError(),
            }
        )
        self.train_metrics = metrics.clone(prefix='train_')
        self.val_metrics = metrics.clone(prefix='val_')
    ...
    def _nan_robust_thresholded_loss_reduction(self, loss: Tensor, y: Tensor, nan_value: float, height_threshold: float) -> Tensor:
        y = (y!=nan_value) & (y>height_threshold)
        loss = torch.masked_select(loss,y)
        return torch.mean(loss) 
